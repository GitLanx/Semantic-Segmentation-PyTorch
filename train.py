...
def main():
    ...
    parser.add_argument('--img_size', type=tuple, help='resize images to proper size')
    parser.add_argument('--dataset_type', type=str, default='sbd', help='choose which dataset to use')
    parser.add_argument('--train_root', type=str, default='/home/ecust/Datasets/PASCAL VOC/benchmark_RELEASE', help='path to train.txt')
